...
config.read("config_pt.properties")
...
logging.basicConfig(filename="logs/pt_monitoring.log", level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')
...
while True:
    for ip in PC_IP:
        ...
        MESSAGE = f"🚨PT Notification Alert🚨\n\nLocation: {DEVICE_LOCATION}\nIP: {ip}\nDate: {CURRENT_DATE}\nTime: {CURRENT_TIME}"
