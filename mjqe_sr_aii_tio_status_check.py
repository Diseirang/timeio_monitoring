...
config.read("config_sr_aii.properties")
...
logging.basicConfig(filename="logs/aii_sr_monitoring.log", level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')
...
while True:
    for ip in PC_IP:
        ...
        MESSAGE = f"🚨Aii-SR Notification Alert🚨\n\nLocation: {DEVICE_LOCATION}\nIP: {ip}\nDate: {CURRENT_DATE}\nTime: {CURRENT_TIME}"
