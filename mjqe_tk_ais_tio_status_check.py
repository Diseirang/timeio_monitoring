...
config.read("config_tk_ais.properties")
...
logging.basicConfig(filename="logs/tk_ais_monitoring.log", level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')
...
while True:
    for ip in PC_IP:
        ...
        MESSAGE = f"🚨AIS_TK Notification Alert🚨\n\nLocation: {DEVICE_LOCATION}\nIP: {ip}\nDate: {CURRENT_DATE}\nTime: {CURRENT_TIME}"
