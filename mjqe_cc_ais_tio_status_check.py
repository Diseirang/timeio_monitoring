...
config.read("config_cc_ais.properties")
...
logging.basicConfig(filename="logs/monitor_cc_ais.log", level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')
...
while True:
    for ip in PC_IP:
        ...
        MESSAGE = f"🚨AIS-CC Notification Alert🚨\n\nLocation: {DEVICE_LOCATION}\nIP: {ip}\nDate: {CURRENT_DATE}\nTime: {CURRENT_TIME}"
